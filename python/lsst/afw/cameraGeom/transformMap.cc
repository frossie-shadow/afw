...
PYBIND11_PLUGIN(_transformMap) {
    ...
    cls.def(pybind11::init<CameraSys const &,
                           std::unordered_map<CameraSys, std::shared_ptr<TransformMap::Transform>> const &>(),
    ...
    cls.def("transform",
            (std::vector<geom::Point2D>(TransformMap::*)(std::vector<geom::Point2D> const &,
                    ...
                    TransformMap::transform,
            "pointList"_a, "fromCoordSys"_a, "toCoordSys"_a);
    cls.def("getTransform", &TransformMap::getTransform, "fromCoordSys"_a, "toCoordSys"_a);
