...
public:
    ...
    */
    explicit SkyWcs(Point2D const &crpix, geom::SpherePoint const &crval, Eigen::Matrix2d const &cdMatrix);
    ...
    */
    geom::SpherePoint getSkyOrigin() const;
    ...
    */
    ...
    geom::SpherePoint pixelToSky(Point2D const &pixel) const { return applyForward(pixel); };
    std::vector<geom::SpherePoint> pixelToSky(std::vector<Point2D> const &pixels) const {
    ...
    */
    ...
    Point2D skyToPixel(geom::SpherePoint const &sky) const { return applyInverse(sky); }
    std::vector<Point2D> skyToPixel(std::vector<geom::SpherePoint> const &sky) const {
